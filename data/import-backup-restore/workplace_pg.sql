...
--
-- Name: employees_pg; Type: TABLE; Schema: public; Owner: postgres
--

CREATE TABLE public.employees_pg (
...
ALTER TABLE public.employees_pg OWNER TO postgres;

--
-- Name: rooms_pg; Type: TABLE; Schema: public; Owner: postgres
--

CREATE TABLE public.rooms_pg (
...
ALTER TABLE public.rooms_pg OWNER TO postgres;

--
-- Data for Name: employees_pg; Type: TABLE DATA; Schema: public; Owner: postgres
--

COPY public.employees_pg (emp_no, birth_date, first_name, last_name, gender, hire_date) FROM stdin;
...
--
-- Data for Name: rooms_pg; Type: TABLE DATA; Schema: public; Owner: postgres
--

COPY public.rooms_pg (room_no, name, capacity) FROM stdin;
1	Austin	25
2	Phoenix	15
3	Portland	10
4	Boston	30
...
--
-- Name: employees_pg employees_pg_pkey; Type: CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.employees_pg
    ADD CONSTRAINT employees_pg_pkey PRIMARY KEY (emp_no);


--
-- Name: rooms_pg rooms_pg_pkey; Type: CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.rooms_pg
    ADD CONSTRAINT rooms_pg_pkey PRIMARY KEY (room_no);
